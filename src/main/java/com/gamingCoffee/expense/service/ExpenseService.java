package com.gamingCoffee.expense.service;
...
import com.gamingCoffee.expense.repository.ExpenseRepository;
import com.gamingCoffee.expense.model.Expense;
import com.gamingCoffee.expense.dao.ExpenseDao;
...
public class ExpenseService {
  ...
  private static final ExpenseRepository expenseDao = new ExpenseDao(
  ...
  public static void removeExpense(int expenseId, String typedPassword) throws SQLException {
    final AdminRepository adminDao = new AdminDao(DatabaseConnection.INSTANCE.getConnection());
