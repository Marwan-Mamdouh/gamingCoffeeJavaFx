package com.gamingCoffee.session.service;
...
import com.gamingCoffee.session.dao.SessionDao;
...
public class SessionService {
  ...
  private static final SessionRepository sessionDao = new SessionDao(
