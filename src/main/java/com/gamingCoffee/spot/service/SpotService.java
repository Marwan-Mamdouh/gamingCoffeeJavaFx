package com.gamingCoffee.spot.service;
...
import com.gamingCoffee.spot.dao.SpotDao;
...
public class SpotService {
  ...
  private static final SpotRepository spotDao = new SpotDao(DatabaseConnection.INSTANCE.getConnection());
